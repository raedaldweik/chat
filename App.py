...
st.title("Citizen Complaint Assistant - Flood Management")

# Path to the CSV file
csv_file_path = 'emails.csv'

# Check if the CSV file exists in the project directory
if os.path.exists(csv_file_path):
    # Read CSV file
    df = pd.read_csv(csv_file_path)
    # Remove display of emails
    # st.write("### Loaded Data from 'emails.csv'")
    # st.dataframe(df)
    ...
    if 'email' not in df.columns:
        ...
        # Create RetrievalQA chain using from_chain_type
